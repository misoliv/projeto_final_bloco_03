...
function CardCategorias({categoria}: Readonly<CardCategoriaProps>) {
    return (
        <div className='border flex flex-col rounded-2xl overflow-hidden justify-between m-10'>
            <header className='py-2 px-6 bg-cyan-400  text-white font-bold text-2xl'>Categoria</header>
