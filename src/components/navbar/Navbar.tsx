import { UserIcon, ShoppingCartIcon, ListIcon, XIcon } from "@phosphor-icons/react";
    ...
    */ 
    ...
    return (
        <>
            ...
            <div className='fixed top-0 left-0 z-50 flex justify-center w-full py-4 text-white bg-cyan-400 md:py-2'>
